...
class TrafficLightsTest {
    ...
    private ITCM baseTCM = new SimpleJunction("base", 200,200, false);
    private ITCM baseTCM1 = new SimpleJunction("adj1", 300,300, false);
    private ITCM baseTCM2 = new SimpleJunction("adj2", 400,400, false);
...
//        fail();
    ...
    void testEnterQueue() {
        // Setup
        final IVehicle vehicle = new Car(trafficLightsUnderTestAdj1, trafficLightsUnderTest);
